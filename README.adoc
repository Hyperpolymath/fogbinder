...
:experimental:
:url-github: https://github.com/hyperpolymath/fogbinder
:url-gitlab: https://gitlab.com/hyperpolymath/fogbinder
:url-bitbucket: https://bitbucket.org/hyperpolymath/fogbinder
:url-codeberg: https://codeberg.org/hyperpolymath/fogbinder

Fog computing orchestration and edge binding
...
fogbinder is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
