...
(define metadata
  '((version . "0.1.0")
    ...
    (updated . "2025-12-15")
    (project . "fogbinder")
    (repo . "github.com/hyperpolymath/fogbinder")))
...
(define project-context
  '((name . "fogbinder")
    (tagline . "link:https://github.com/hyperpolymath/rhodium-standard-repositories[image:badges/rhodium.svg[RSR Rhodium,align=center]]")
    (version . "0.1.0")
